...
| `priya` | The signing queue: confirm identity once, agree to sign electronically once, and sign five orders in a row — three taps each, opening one after another. |
